<div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex gap-10 py-12">
        ...
        <div class="w-full">
            <form class="mb-4">
                <input type="text" placeholder="Buscar por título de pregunta" class="bg-slate-800 border-0 rounded-md w-1/3 p-3 text-white/60 text-xs" wire:model.live="search">
            </form>
